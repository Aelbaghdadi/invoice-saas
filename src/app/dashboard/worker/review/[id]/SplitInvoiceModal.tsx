                      ...
                      <div
                        className={`absolute pointer-events-none ${
                          selectionConfirmed
                            ...
                            : "border-2 border-blue-500 bg-blue-400/10"
                        }`}
                        style={{
            ...
            <div className="flex-shrink-0 flex items-center justify-between gap-2 border-t border-slate-100 px-5 py-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-[13px] font-medium text-blue-700 hover:bg-blue-100 disabled:opacity-40"
                >
